...
The compiler is written in Rust. We chose Rust because the author had the most expierence with this language. Rust also has a number of other programming languages written in it, which we used as a reference. Specifically, we looked at Gluon@ref_gluon, Gleam@ref_gleam, and RustPython@ref_rspy.
